...
\begin{document}
    ...
    % ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    \subsubsection*{コメント}
    順序統計量\index{じゅんじょとうけいりょう@順序統計量}はとっても難しいけど、メタな話、一様分布\index{いちようぶんぷ@一様分布}くらいしか出ないので一通りやり方をさらっておこう。
    場合分けはいちいち書いていると脳が破壊されるので、適宜指示関数\index{しじかんすう@指示関数}を使いながら機械的に処理できるようにしておくとよい
    (指示関数に拘って逆に混乱しないように)。
